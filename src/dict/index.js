...
const t = i18n.t
const callType = new DataDictionary([
  { id: '0', name: i18n.t('voice.InboundCall') },
  { id: '1', name: i18n.t('voice.OutboundCall') },
  { id: '2', name: i18n.t('voice.MissedCall') }
])
...
export { callType, fieldTypes, msgType, sendStatus }
